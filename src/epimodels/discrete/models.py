...
model_types = {
    ...
    'S3': 'Susc_age3', 'E3': 'Incub_age3', 'Is3': 'Subc_age3', 'Ic3': 'Sympt_age3', 'Ig3': 'Comp_age3',
    'S4': 'Susc_age4', 'E4': 'Incub_age4', 'Is4': 'Subc_age4', 'Ic4': 'Sympt_age4', 'Ig4': 'Comp_age4'},
                  'parameters':{
...
class DiscreteModel(BaseModel):
    ...
    #     params = redisclient.hgetall("{}:params".format(self.geocode))
    #     params = {k: float(v) for k, v in params.items()}
    #     values = [float(i) for i in redisclient.lrange("{}:values".format(self.geocode), 0, -1)]
    #     return inits, simstep, totpop, theta, npass, bi, params, values
    #
...
def stepFlu(inits: list, timesteps: int, totpop: int, params: dict) -> dict:
    """
    ...
    S1[0], E1[0], Is1[0], Ic1[0], Ig1[0], S2[0], E2[0], Is2[0], Ic2[0], Ig2[0], S3[0], E3[0], Is3[0], Ic3[0], Ig3[0], S4[0], E4[0], Is4[0], Ic4[0], Ig4[0] = inits
    N = totpop
    ...
    for i in tspan[:-1]:
        ...
        Infectantes = Ig1[i] + Ig2[i] + Ig3[i] + Ig4[i] + Ic1[i] + Ic2[i] + Ic3[i] + Ic4[i] + 0.5 * (Is1[i] + Is2[i] + Is3[i] + Is4[i])
...
def stepSIS(inits: list, timesteps: int, totpop: int, params: dict) -> dict:
    """
...
def stepSIR(inits: list, timesteps: int, totpop: int, params: dict) -> dict:
    """
